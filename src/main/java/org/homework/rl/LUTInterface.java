...
public interface LUTInterface extends CommonInterface {
   ...
   *     vector.
   * @param argVariableCeiling An array specifying the highest value of each of the variables in the
   *     input vector. The order must match the order as referred to in argVariableFloor.
  ...
  /**
   * A helper method that translates a vector being used to index the look up table into an ordinal
   * that can then be used to access the associated look up table element.
   *
